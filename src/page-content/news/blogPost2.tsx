...
const blog: BlogPostData = {
  ...
  renderBody: styles => (
    <>
      ...
      New AI Alliance Members Include: Anaconda; Applied Digital; Citadel AI; Core42; Databricks; Domino Data Lab; ESADE, Hitachi; Impact AI; Kera Health Platforms; LastMile AI; Lightning AI; MLOps Community; NEC Corporation; New Native Inc.; Neo4j; Northeastern University; Predibase; SeedAI; Snowflake, Inc.; Uber; University at Buffalo; University of Pennsylvania; University of Technology in Poznan: Interdisciplinary Centre for Artificial Intelligence and Cybersecurity; University of Utah; Weights & Biases (ML/LLMops); and Zilliz
      </motion.p>
      <section>
        <motion.p {...showInView}>
        ...
        The <strong>AI Alliance AI Safety and Trust Tooling</strong> working group will:
        </motion.p>
        <ul>
        ...
        <motion.p {...showInView} className={styles.enlargeSpacing}>
        The <strong>AI Alliance AI Policy Advocacy</strong> working group will:
        </motion.p>
        <ul>
          <motion.li {...showInView}>
...
<motion.blockquote {...showInView}>
  ...
  “Open innovation propels responsible and equitable progress in artificial intelligence, fostering collaboration among diverse entities. Applied Digital leads with state-of-the-art low-cost digital infrastructure, strategically placing data centers at the power generation source for high-performance computing applications. Our commitment to the IBM AI Alliance aligns seamlessly with our mission, championing responsible AI development and sustainability through collaborative efforts with industry leaders, academia, and government.”
</motion.blockquote>

<motion.blockquote {...showInView}>
  <strong>Talal Al Kaissi, EVP and Chief Product and Global Partnerships Officer: </strong>
  “At Core42, our purpose is to accelerate what people, enterprises and nations can achieve with AI. Joining the AI Alliance allows us to partner with global technology leaders to mold the future of AI while collaborating openly and sharing knowledge, tools, and resources. By doing so, we aim to expedite our collective progress and guarantee that the benefits of AI reach everyone in a manner that is ethical and inclusive.”
</motion.blockquote>

<motion.blockquote {...showInView}>
  <strong>Kenny Song, Co-Founder & CTO, Citadel AI: </strong>
  “Citadel AI builds tools to validate and monitor the quality of AI systems, including our open-source LLM evaluation toolkit, LangCheck. We’re excited to contribute to the AI Alliance and advance our shared mission of making the world's AI systems more reliable.”
</motion.blockquote>

<motion.blockquote {...showInView}>
  <strong>Naveen Rao, VP of Generative AI, Databricks:</strong>
  “At Databricks, we're committed to open source innovation in AI. We believe innovation accelerates when researchers share ideas through open source. We’re the original creators of MLflow, one of the most popular open source AI tools, and we’re carrying on that legacy with Mosaic AI, including open AI models. We’re excited to join the AI Alliance and further its mission to support and enhance open innovation across the AI landscape. Together, we’ll accelerate progress, improve safety, security, and trust in AI, and maximize benefits to people and society everywhere.”
</motion.blockquote>

<motion.blockquote {...showInView}>
  <strong>Nick Elprin, CEO and co-founder of Domino Data Lab: </strong>
  “The AI Alliance embodies the principles of openness, flexibility, and responsibility that guide the world's top AI innovators. We’re proud to support these innovators together, ensuring AI's benefits are both far-reaching and responsibly realized.”
</motion.blockquote>

<motion.blockquote {...showInView}>
  <strong>Itaru Nishizawa, Vice President & CTO, Hitachi, Ltd.: </strong>
...
<motion.blockquote {...showInView}>
  <strong>Rajeev Alur, Zisman Family Professor of Computer and Information Science and Founding Director, ASSET Center, University of Pennsylvania: </strong>
