...
const logos = [
  ...
  { size: 2, src: FPT, alt: 'FPT' },
  { size: 3, src: HUJI, alt: 'HUJI' },
  { size: 1, src: ibm, alt: 'IBM' },
  { size: 1, src: INSAIT, alt: 'INSAIT' },
  { size: 2, src: intel, alt: 'Intel' },
  { size: 6, src: keio, alt: 'keio' },
  { size: 1, src: linux, alt: 'Linux' },
  { size: 1, src: mass, alt: 'Mass' },
  { size: 1, src: MBZUAI, alt: 'MBZUAI' },
  { size: 1, src: meta, alt: 'Meta' },
  { size: 1, src: mlcommons, alt: 'ML Commons' },
  { size: 1, src: munich, alt: 'Munich' },
  { size: 1, src: notre_dame, alt: 'Notre Dame' },
  { size: 2, src: nyu, alt: 'NYU' },
  { size: 1, src: red_hat, alt: 'RedHat' },
  { size: 1, src: roadzen, alt: 'Roadzen' },
  { size: 1, src: rpi, alt: 'RPI' },
  { size: 1, src: sbintuitions, alt: 'sbintuitions' },
  { size: 1, src: servicenow, alt: 'ServiceNow' },
  { size: 1, src: simons, alt: 'simons' },
  { size: 1, src: sony, alt: 'sony' },
  { size: 1, src: together, alt: 'together' },
  { size: 1, src: tokyo, alt: 'tokyo' },
  { size: 1, src: uiuc, alt: 'uiuc' },
  { size: 1, src: yale, alt: 'yale' },
];
