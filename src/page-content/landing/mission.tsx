      ...
      <Grid className={styles.mission__grid}>
        ...
        >
          <motion.p {...showInView}>
            ...
            foundational capabilities, safety, security and trust in AI, and to
            responsibly maximize benefits to people and society everywhere.
          </motion.p>
          <motion.p {...showInView}>
        ...
        <Column sm={4} data-viewport="small">
          <motion.div {...showInView} className={styles.smallScreenCtaWrapper}>
            <AnimatedButton
              onClick={onLearnMore}
              className={styles.cta}
              icon={<ArrowRight />}
